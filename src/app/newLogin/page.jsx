const Login = () => {
  return (
    <section className="bg-[#f8cca6] w-full min-h-screen flex box-border justify-center items-center">
      <div className="bg-[#e7af7d] rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="px-8">
          ...
          <div className=" text-sm border-b border-gray-500 py-5 playfair tooltip">
            Forget password?
          </div>
